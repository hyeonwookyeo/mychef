...
<%@ include file="./include/header.jsp"%>
	...
	<div class="container px-4 px-lg-5">
		...
		<div class="row gx-4 gx-lg-5 align-items-center my-5">
			...
			<div class="col-lg-5">
				<h1 class="font-weight-light">다양한 레시피를 <br> 만나보세요</h1>
				<p>요리가 어려우세요? 알고보면 쉬운 요리도 많아요. 하고 싶은 요리를 찾아 따라해보세요! <br>실력이 쑥쑥!</p>
		 ...
		 <!-- Features section-->
            <section class="py-5" id="free_board">
	...
	<footer class="py-5 bg-dark">
		<div class="container px-4 px-lg-5">
			<ul class="nav justify-content-end">
				<li class="nav-item"><a class="nav-link text-white" href="a_loginform">관리자
						로그인</a></li>
			</ul>
