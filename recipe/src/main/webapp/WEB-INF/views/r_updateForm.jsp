	...
	<div class="container" align="center">
		...
		<form enctype="multipart/form-data">
			...
			<table border=1>
				...
				<tr>
					...
					<td><input type="file" id="thumbnail1" name="thumbnail1"
						onchange="readURL(this);" class="file"> <img id="preview"
						src="images/chinese.jpg" width=300 height=350 /></td>
				</tr>
				<tr>
					<td>간략한 설명</td>
			...
			<table border=1>
				...
				<c:forEach var="item1" items="${map1 }">
					...
					<tr>
						...
						<input type="text"	name='ingre' value="${item1.key }"></td>
						<td style='text-align: center;'>
						<input type="text"	name='capacity' value="${item1.value }"></td>
						<td style='text-align: center;'>
							<div class="btn-group">
								<button type='button' 
			...
			<table border=1>
				<tr>
					<td>조리사진</td>
					<td><input type="file" multiple="multiple" id="r_file1"
						name="r_file1" onchange="readURL(this);"> <img id="cook1"
			...
			<br> <br> <input type="button" value="확인" id="sub">
